...
const myCreatedDate=new Date(2023,10, 3);
console.log(`My Created Date is ${myCreatedDate}`);
...
const anotherFormatOfDate=new Date("11-03-2001"); //we have defined our own format as MM/DD//YYYY;
console.log(anotherFormatOfDate);
